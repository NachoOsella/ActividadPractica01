...
namespace Comercio.Utils
{
    public class DataHelper
    {
        ...
        private DataHelper()
        {
            _connection = new SqlConnection("Data Source=NOTEBOOK\\SQLEXPRESS;Initial Catalog=ComercioDB;Integrated Security=True;Encrypt=False");
        }
